...
using Fiap.FCG.User.Unit.Test.WebApi.Usuarios.Consultar.Fakers;
using Fiap.FCG.User.Unit.Test.WebApi.Usuarios.Consultar.Fixtures;
using FluentAssertions;
using Microsoft.AspNetCore.Mvc;
using Xunit;

namespace Fiap.FCG.User.Unit.Test.WebApi.Usuarios.Consultar;
