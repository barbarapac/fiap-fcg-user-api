...
using Fiap.FCG.User.Unit.Test.Application.Autenticacao.Fakers;
using Fiap.FCG.User.Unit.Test.Application.Autenticacao.Fixtures;
using FluentAssertions;
using Xunit;

namespace Fiap.FCG.User.Unit.Test.Application.Autenticacao;
